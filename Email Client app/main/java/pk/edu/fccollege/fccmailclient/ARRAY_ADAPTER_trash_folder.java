...
public class ARRAY_ADAPTER_trash_folder extends ArrayAdapter {
    private ArrayList<email_body> trash_array;
    private Context mycontext;
    private int resId;
    private ARRAY_ADAPTER_trash_folder adapter;

    public ARRAY_ADAPTER_trash_folder(@NonNull Context context, int resource, ArrayList<email_body> trash_array) {
        super(context, resource,trash_array);

        this.trash_array = trash_array;
        TRASH_frag.trash_array_modified=trash_array;
        mycontext = context;
        resId = resource;
        adapter = this;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        email_body extract_email = TRASH_frag.trash_array_modified.get(position);
        ...
        if(extract_email.folder.matches("delete")){
    ...
    @Override
    public int getCount() {
        return TRASH_frag.trash_array_modified.size();
    }

    @Override
    public Object getItem(int position) {
        return TRASH_frag.trash_array_modified.get(position);
    }
        ...
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint == null || constraint.length() == 0){
                    filterResults.count = trash_array.size();
                    filterResults.values = trash_array;
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                TRASH_frag.trash_array_modified = (ArrayList<email_body>) results.values;
